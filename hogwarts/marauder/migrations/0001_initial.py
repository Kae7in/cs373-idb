...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('marauder_character', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, default='images/empty.jpg')),
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Creature'], related_name='characters')),
            ('house', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.House'], related_name='students')),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Shop'], related_name='owners')),
        ))
        ...
        db.create_table('marauder_creature', (
            ...
            ('rating', self.gf('django.db.models.fields.CharField')(blank=True, max_length=10)),
        ...
        db.create_table('marauder_spell', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Creature'], related_name='spells')),
        ))
        ...
        db.create_table('marauder_ingredient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Creature'], related_name='ingredients')),
        ))
        ...
        db.create_table('marauder_house', (
            ...
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marauder.School'], related_name='houses')),
            ('ghost', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['marauder.Character'], related_name='houses_haunted')),
        ...
        db.create_table('marauder_artifact', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, default='images/empty.jpg')),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Shop'], related_name='artifacts')),
        ))
        ...
        db.create_table('marauder_book', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Character'], related_name='books_published')),
            ('publisher', self.gf('django.db.models.fields.CharField')(blank=True, max_length=200, null=True)),
        ...
        db.create_table('marauder_story', (
            ...
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Book'], related_name='story')),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, default='images/empty.jpg')),
        ))
        ...
        db.create_table('marauder_academic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Character'], related_name='academic_statuses')),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.School'], related_name='academic_statuses')),
            ('descriptor', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('marauder', ['Academic'])

        # Adding model 'Relationship'
        db.create_table('marauder_relationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Character'], related_name='relationships1')),
            ('character2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['marauder.Character'], related_name='relationships2')),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('marauder_academic')
    ...
    models = {
        'marauder.academic': {
            ...
            'character': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Character']", 'related_name': "'academic_statuses'"}),
            'descriptor': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'school': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.School']", 'related_name': "'academic_statuses'"})
        },
        'marauder.artifact': {
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['marauder.Character']", 'null': 'True', 'symmetrical': 'False', 'related_name': "'artifacts'"}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Shop']", 'related_name': "'artifacts'"})
        },
        'marauder.book': {
            'Meta': {'object_name': 'Book'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Character']", 'related_name': "'books_published'"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'default': "'images/empty.jpg'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['marauder.Character']", 'null': 'True', 'symmetrical': 'False', 'related_name': "'books_starred'"})
        },
        'marauder.character': {
            'Meta': {'object_name': 'Character'},
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Creature']", 'related_name': "'characters'"}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'house': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.House']", 'related_name': "'students'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'default': "'images/empty.jpg'"}),
            ...
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Shop']", 'related_name': "'owners'"}),
        ...
        'marauder.creature': {
            ...
            'rating': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '10'})
        },
        'marauder.house': {
        ...
        'marauder.ingredient': {
            ...
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Creature']", 'related_name': "'ingredients'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'marauder.location': {
        ...
        'marauder.potion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'default': "'images/empty.jpg'"}),
            'ingredients': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['marauder.Ingredient']", 'null': 'True', 'symmetrical': 'False', 'related_name': "'potions'"}),
        ...
        'marauder.relationship': {
            ...
            'character1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Character']", 'related_name': "'relationships1'"}),
            'character2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Character']", 'related_name': "'relationships2'"}),
        ...
        'marauder.shop': {
            ...
            'location_ptr': ('django.db.models.fields.related.OneToOneField', [], {'primary_key': 'True', 'unique': 'True', 'to': "orm['marauder.Location']"}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['marauder.Location']", 'null': 'True', 'symmetrical': 'False', 'related_name': "'shops'"})
        },
        'marauder.spell': {
            'Meta': {'object_name': 'Spell'},
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'creator': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Creature']", 'related_name': "'spells'"}),
        ...
        'marauder.story': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'null': 'True', 'to': "orm['marauder.Book']", 'related_name': "'story'"}),
