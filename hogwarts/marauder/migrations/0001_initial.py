...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('marauder_character', (
            ...
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='characters', null=True, to=orm['marauder.Creature'], blank=True)),
            ('house', self.gf('django.db.models.fields.related.ForeignKey')(related_name='members', null=True, to=orm['marauder.House'], blank=True)),
            ('school_attended', self.gf('django.db.models.fields.related.ForeignKey')(related_name='students', null=True, to=orm['marauder.School'], blank=True)),
            ('school_taught', self.gf('django.db.models.fields.related.ForeignKey')(related_name='professors', null=True, to=orm['marauder.School'], blank=True)),
            ('school_headmastered', self.gf('django.db.models.fields.related.ForeignKey')(related_name='headmasters', null=True, to=orm['marauder.School'], blank=True)),
            ('school_founded', self.gf('django.db.models.fields.related.ForeignKey')(related_name='founders', null=True, to=orm['marauder.School'], blank=True)),
            ('school_staffed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='staff', null=True, to=orm['marauder.School'], blank=True)),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='owners', null=True, to=orm['marauder.Shop'], blank=True)),
        ))
        ...
        db.create_table('marauder_creature', (
            ...
            ('notable', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ...
        db.create_table('marauder_spell', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='spells', null=True, to=orm['marauder.Creature'], blank=True)),
        ))
        ...
        db.create_table('marauder_ingredient', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('creature', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ingredients', null=True, to=orm['marauder.Creature'], blank=True)),
        ))
        ...
        db.create_table('marauder_school', (
            ('location_ptr', self.gf('django.db.models.fields.related.OneToOneField')(primary_key=True, unique=True, to=orm['marauder.Location'])),
        ...
        db.create_table('marauder_house', (
            ('school_ptr', self.gf('django.db.models.fields.related.OneToOneField')(primary_key=True, unique=True, to=orm['marauder.School'])),
        ...
        db.create_table('marauder_artifact', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(default='images/empty.jpg', max_length=100)),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='artifacts', null=True, to=orm['marauder.Shop'], blank=True)),
        ))
        ...
        db.create_table('marauder_book', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='books_published', null=True, to=orm['marauder.Character'], blank=True)),
            ('publisher', self.gf('django.db.models.fields.CharField')(null=True, max_length=200, blank=True)),
        ...
        db.create_table('marauder_story', (
            ...
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(related_name='story', null=True, to=orm['marauder.Book'], blank=True)),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('image', self.gf('django.db.models.fields.files.ImageField')(default='images/empty.jpg', max_length=100)),
        ))
        ...
        db.create_table('marauder_relationship', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('character1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships1', null=True, to=orm['marauder.Character'], blank=True)),
            ('character2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relationships2', null=True, to=orm['marauder.Character'], blank=True)),
    ...
    models = {
        'marauder.artifact': {
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'artifacts'", 'null': 'True', 'to': "orm['marauder.Character']", 'blank': 'True'}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'artifacts'", 'null': 'True', 'to': "orm['marauder.Shop']", 'blank': 'True'})
        },
        'marauder.book': {
            'Meta': {'object_name': 'Book'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'books_published'", 'null': 'True', 'to': "orm['marauder.Character']", 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'images/empty.jpg'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            ...
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'books_starred'", 'null': 'True', 'to': "orm['marauder.Character']", 'blank': 'True'})
        },
        'marauder.character': {
            'Meta': {'object_name': 'Character'},
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'characters'", 'null': 'True', 'to': "orm['marauder.Creature']", 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'house': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'members'", 'null': 'True', 'to': "orm['marauder.House']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'images/empty.jpg'", 'max_length': '100'}),
            ...
            'school_attended': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'students'", 'null': 'True', 'to': "orm['marauder.School']", 'blank': 'True'}),
            'school_founded': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'founders'", 'null': 'True', 'to': "orm['marauder.School']", 'blank': 'True'}),
            'school_headmastered': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'headmasters'", 'null': 'True', 'to': "orm['marauder.School']", 'blank': 'True'}),
            'school_staffed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'staff'", 'null': 'True', 'to': "orm['marauder.School']", 'blank': 'True'}),
            'school_taught': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'professors'", 'null': 'True', 'to': "orm['marauder.School']", 'blank': 'True'}),
            'shop': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'owners'", 'null': 'True', 'to': "orm['marauder.Shop']", 'blank': 'True'}),
        ...
        'marauder.creature': {
            ...
            'notable': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'marauder.ingredient': {
            ...
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ingredients'", 'null': 'True', 'to': "orm['marauder.Creature']", 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'marauder.location': {
        ...
        'marauder.potion': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'images/empty.jpg'", 'max_length': '100'}),
            'ingredients': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'potions'", 'null': 'True', 'to': "orm['marauder.Ingredient']", 'blank': 'True'}),
        ...
        'marauder.relationship': {
            ...
            'character1': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relationships1'", 'null': 'True', 'to': "orm['marauder.Character']", 'blank': 'True'}),
            'character2': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'relationships2'", 'null': 'True', 'to': "orm['marauder.Character']", 'blank': 'True'}),
        ...
        'marauder.shop': {
            ...
            'location_ptr': ('django.db.models.fields.related.OneToOneField', [], {'primary_key': 'True', 'unique': 'True', 'to': "orm['marauder.Location']"}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'shops'", 'null': 'True', 'to': "orm['marauder.Location']", 'blank': 'True'})
        },
        'marauder.spell': {
            'Meta': {'object_name': 'Spell'},
            'alias': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'creator': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'creature': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'spells'", 'null': 'True', 'to': "orm['marauder.Creature']", 'blank': 'True'}),
        ...
        'marauder.story': {
            ...
            'artifacts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['marauder.Artifact']", 'related_name': "'stories'"}),
            'book': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'story'", 'null': 'True', 'to': "orm['marauder.Book']", 'blank': 'True'}),
            'characters': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['marauder.Character']", 'related_name': "'stories'"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'images/empty.jpg'", 'max_length': '100'}),
            'kind': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'locations': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['marauder.Location']", 'related_name': "'stories'"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }
