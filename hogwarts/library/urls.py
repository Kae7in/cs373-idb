...
urlpatterns = patterns('django.views.generic.simple',
    ...
    #Books
    (r'^books/$', TemplateView.as_view(template_name='books/index.html')),
    (r'^books/1$', TemplateView.as_view(template_name='books/1.html')),
    (r'^books/2$', TemplateView.as_view(template_name='books/2.html')),
    (r'^books/3$', TemplateView.as_view(template_name='books/3.html')),
)
